...
Support for the materials in this section is given in [the lecture notes](https://comp2870-2526.github.io/linear-algebra-notes/src/lec02.html).
...
1.  Produce a table of values of `n`, `pi_approx(n)` and the error between $\pi$ and its approximation for `n` between 0 and 50 inclusive.
    How many correct digits can you achieve?

2.  Iterating further after the best approximation, what would you see? Why?
...
4.  How many correct digits can you achieve now? If you make more and more iterations after the best approximation, comment on what you observe by considering each term in your iteration formula.
